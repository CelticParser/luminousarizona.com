...
- **`projects`** - Main project files (one per project directory)
- **`images`** - Individual image pages within projects
- **`about`** - About page content
...
- **Line 21:** Add some history notes -->
